...
function findWasmBinary() {
    return locateFile('clothMovement.wasm');
}
...
var ASM_CONSTS = {
 ...
 102590: ($0) => { document.getElementById("canvas").style.cursor = UTF8ToString($0); },  
 102661: () => { document.getElementById('canvas').style.cursor = 'none'; },  
 102718: () => { return window.mouseX || 0; },  
 102749: () => { return window.mouseY || 0; },  
 102780: ($0) => { var canvas = document.getElementById('canvas'); if ($0) { canvas.style.pointerEvents = 'none'; } else { canvas.style.pointerEvents = 'auto'; } },  
 102927: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102980: () => { return window.innerWidth; },  
 103010: () => { return window.innerHeight; },  
 103041: ($0, $1) => { var ext = UTF8ToString($0, $1); var canvas = document.querySelector('canvas'); var gl = canvas.getContext('webgl') || canvas.getContext('experimental-webgl'); if (!gl) return 0; var supported = gl.getSupportedExtensions(); return supported && supported.includes(ext) ? 1 : 0; },  
 103321: () => { Module.requestFullscreen(false, true); },  
 103360: () => { Module.exitFullscreen(false, true); },  
 103396: ($0, $1) => { var element = document.getElementById("canvas"); if (element) element.style.opacity = $1; }
};
